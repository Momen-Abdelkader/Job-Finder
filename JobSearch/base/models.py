...
class UserProfile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, limit_choices_to={'is_admin': False})
...
class AdminProfile(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, limit_choices_to={'is_admin': True})
    company_name = models.CharField(max_length=100)
   
    def __str__(self):
        return "Company Profile: " + self.user.username + " " + self.company_name
...
class JobApplication(models.Model):
    ...
    def __str__(self):
        return self.user.user.username + " applied to " + self.job.job_title + " at " + str(self.date)
...
class UserSkill(models.Model):
    ...
    def __str__(self):
        return self.user.user.username + " " + self.skill.skill
